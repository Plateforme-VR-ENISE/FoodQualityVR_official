...
copytree((currentFolder+ r'\eclaire_2048') , (currentFolder+ r'\eclaire_1024'))
replaceTexture(currentFolder+ r'\eclaire_1024',2048,1024)
copytree((currentFolder+ r'\eclaire_2048') , (currentFolder+ r'\eclaire_512'))
replaceTexture(currentFolder+ r'\eclaire_512',2048,512)
copytree((currentFolder+ r'\eclaire_2048') , (currentFolder+ r'\eclaire_256'))
replaceTexture(currentFolder+ r'\eclaire_256',2048,256)
