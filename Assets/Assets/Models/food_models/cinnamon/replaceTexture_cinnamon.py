...
copytree((currentFolder+ r'\cinnamon_2048') , (currentFolder+ r'\cinnamon_1024'))
replaceTexture(currentFolder+ r'\cinnamon_1024',2048,1024)
copytree((currentFolder+ r'\cinnamon_2048') , (currentFolder+ r'\cinnamon_512'))
replaceTexture(currentFolder+ r'\cinnamon_512',2048,512)
copytree((currentFolder+ r'\cinnamon_2048') , (currentFolder+ r'\cinnamon_256'))
replaceTexture(currentFolder+ r'\cinnamon_256',2048,256)
